...
describe('Testando a API Cacau Trybe', function () {
  ...
  describe('Usando o metodo GET em /chocolates/:id para buscar ID 4', function () {
  ...
  describe('Usando o metodo GET em chocolates/:id para ID 99', function () {
    it('retorna erro 404', async function () {
  ...
  describe('usando metodo get em chocolates/brand/:brandId para brandId 1', function () {
    it('retorna chocolates da marca Lindt & Sprungli', async function () {
